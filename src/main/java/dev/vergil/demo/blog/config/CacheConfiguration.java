package dev.vergil.demo.blog.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, dev.vergil.demo.blog.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, dev.vergil.demo.blog.repository.UserRepository.USERS_BY_EMAIL_CACHE);
