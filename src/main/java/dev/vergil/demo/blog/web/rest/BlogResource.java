...
import dev.vergil.demo.blog.domain.Blog;
import dev.vergil.demo.blog.service.BlogService;
...
/**
 * REST controller for managing {@link dev.vergil.demo.blog.domain.Blog}.
 */
@RestController
@RequestMapping("/api")
